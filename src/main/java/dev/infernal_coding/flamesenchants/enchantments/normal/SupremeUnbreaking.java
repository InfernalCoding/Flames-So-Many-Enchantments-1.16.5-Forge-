...
public class SupremeUnbreaking extends UnbreakingEnchantment {
    ...
    public boolean canApplyTogether(Enchantment ench) {
        return super.canApplyTogether(ench) && ench != Enchantments.UNBREAKING && ench != Registry.ADVANCED_UNBREAKING.get();
    }
}
